...
<div id="barcodes-wrapper-tooltip">
    <div id="barcodes-tooltip"><?php echo __("Select categories and press this button to create barcodes.", "wpbcu-barcode-generator"); ?></div>
    <button type="button" name="barcodes_import_orders" id="barcodes-import-categories" class="button" data-action-type="categories">
