...
<div id="barcodes-wrapper-tooltip">
    <div id="barcodes-tooltip"><?php echo __("Select messages and press this button to create barcodes.", "wpbcu-barcode-generator"); ?></div>
    <button type="button" name="barcodes_import_cf_messages" id="barcodes-import-cf-messages" class="button" data-action-type="cf-messages">
        ...
        <?php echo __("Generate Barcodes", "wpbcu-barcode-generator") ?>
    </button>
</div>
