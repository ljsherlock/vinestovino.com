...
<div id="barcodes-wrapper-tooltip">
    <div id="barcodes-tooltip"><?php echo __("Select orders and press this button to create barcodes.", "wpbcu-barcode-generator"); ?></div>
    <button type="button" name="barcodes_import_orders" id="barcodes-import-orders" class="button" data-action-type="orders">
        ...
        <?php echo __("Order label", "wpbcu-barcode-generator") ?>
    </button>
</div>
