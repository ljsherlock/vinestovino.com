...
<div id="barcodes-wrapper-tooltip">
    <div id="barcodes-tooltip"><?php echo __("Select coupons and press this button to create barcodes.", "wpbcu-barcode-generator"); ?></div>
    <button type="button" name="barcodes_import_wc_coupons" id="barcodes-import-wc-coupons" class="button" data-action-type="wc-coupons">
        ...
        <?php echo __("Create Label", "wpbcu-barcode-generator") ?>
    </button>
</div>
