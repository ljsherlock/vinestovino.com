                                                                    ...
                                                                    ?>
                                                                        <div class="etn-checkbox-field">
                                                                            <input type="checkbox" 
                                                                                ...
                                                                                data-etn_required="<?php esc_attr_e( $etn_field_type );?>"
                                                                                <?php esc_attr_e( $etn_field_type ); ?>
                                                                            />
                                                                            <label for="<?php esc_attr_e( $id );?>"><?php echo html_entity_decode( $checkbox_val );?></label>
                                                                        </div>
                                                                    <?php
                                                                }
                                                            ?>
