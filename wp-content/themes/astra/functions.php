...
function boostpress_admin_neworder_to_email_subject( $subject, $order ) {
$subject = 'WINE ORDER #' . $order->get_order_number() . ' [ ' . $order->get_billing_first_name() . ' ' . $order->get_billing_last_name(). ' ] ';
return $subject;

};
add_filter( 'woocommerce_email_subject_new_order', 'boostpress_admin_neworder_to_email_subject', 10, 2 );
...
function yoursite_pre_user_search($user_search) {
    ...
    $search_array = array("billing_first_name", "billing_last_name", "billing_company");
